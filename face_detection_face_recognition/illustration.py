...
def corp_face(image_array, size, landmarks):
    ...
    lip_landmark = landmarks['top_lip'] + landmarks['bottom_lip']
...
def face_preprocess(image, landmark_model_type = 'large', crop_size = 128):
...
if __name__=='__main__':
    ...
    face, landmarks = face_preprocess(image = image_array, landmark_model_type = 'large', crop_size = 128)
