...
if __name__ == "__main__":
    ...
    parser.add_argument('--inpath', type = str, default = 'C:\\Users\\ZHAO Yuzhi\\Desktop\\dataset\\old image2', help = 'pre-train or not')
    parser.add_argument('--outpath', type = str, default = '', help = 'savi is recommended')
