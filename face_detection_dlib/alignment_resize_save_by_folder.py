...
def save_by_folder(imglist, size, savepath):
...
if __name__ == "__main__":
    ...
    imgpath = 'E:\\dataset, task related\\Face Dataset\\CelebA\\Img\\img_align_celeba_png'
    savepath = 'F:\\dataset, task related\\Face Dataset\\CelebA\\Img_128_dlib'
    size = 128
    imglist = get_files(imgpath)
    save_by_folder(imglist, size, savepath)
